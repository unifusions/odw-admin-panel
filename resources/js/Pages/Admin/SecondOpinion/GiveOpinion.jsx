...
export default function GiveOpinion({ so, isDisabled }) {
    ...
    const onsubmit = (e) => {
        ...
        post(route('second-opinion.replies.store', so), {
            forceFormData: true,
            onFinish: closeModal()
        });
    ...
    return (
        <>
            <button className="btn btn-primary me-2"
                ...
                disabled={isDisabled} type="submit">{processing ? <Spinner currentColor="warning" /> : 'Give Opinion'} </button>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <div className="modal-header">
                                <h5 className="modal-title">Give Opinion</h5>
                            </div>
                        </div>
