...
export default function AuthenticatedLayoutOld({ header, children, callToAction, pageTitle }) {
                ...
                <main id="content" role="main" className="main">
                    ...
                    <div className="footer">
                        <div className="row justify-content-between align-items-center">
                            <div className="col">
                                <p className="fs-6 mb-0">&copy; 2025-26. <span className="d-none d-sm-inline-block">OneDentalWorld.</span></p>
                            </div>
